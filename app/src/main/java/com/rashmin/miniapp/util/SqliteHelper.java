package com.rashmin.miniapp.util;
...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    private final String TABLE1_COL3="category";
    ...
    public List<Product> getAllProducts()
    {
        ...
        if(cursor!=null)
        {
            ...
            while (cursor.moveToNext())
            {
                ...
                Product product=new Product(Integer.parseInt(id),name,category,description, Integer.parseInt(price));
